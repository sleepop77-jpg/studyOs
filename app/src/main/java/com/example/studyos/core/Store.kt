...
object Store {
    val ITEMS = listOf(
        Item(
            id = "item_halo_scholar",
            name = "Scholar Halo",
            description = "Animated golden halo for the mascot.",
            type = "Mascot",
            cost = 120
        ),
        Item(
            id = "item_ninja_headband",
            name = "Ninja Headband",
            description = "A disciplined study-warrior headband.",
            type = "Mascot",
            cost = 150
        ),
        Item(
            id = "item_party_mode",
            name = "Party Mode",
            description = "Tiny celebration aura around the mascot.",
            type = "Mascot",
            cost = 180
        ),
        Item(
            ...
            description = "Neon visor for late-night focus sessions.",
            type = "Mascot",
            cost = 220
        ),
        Item(
            id = "item_night_owl_skin",
            name = "Night Owl Cap",
            description = "Sleepy focus cap with moonlight vibes.",
            type = "Mascot",
            cost = 240
        ),
        Item(
            id = "item_golden_desk",
            name = "Golden Desk",
            description = "Premium golden study desk trim.",
            type = "Mascot",
            cost = 260
        ),
        Item(
            id = "item_aurora_dream",
            name = "Aurora Dream",
            description = "Animated northern-light study background.",
            type = "Theme",
            cost = 260
        ),
        Item(
            id = "item_math_matrix",
            name = "Math Matrix",
            description = "Dark green matrix-inspired theme.",
            type = "Theme",
            cost = 180
        ),
        Item(
            id = "item_spanish_fiesta",
            name = "Sol & Coral Palette",
            description = "Warm Andalusian sunset colors.",
            type = "Theme",
            cost = 200
        ),
        ...
        Item(
            ...
            name = "Astral Crown",
            description = "Holographic crown with orbiting constellations.",
            type = "Mascot",
            cost = 450
        ),
        Item(
            id = "item_dragon_aura",
            name = "Dragon Aura",
            description = "Animated ethereal dragon flames and floating embers.",
            type = "Mascot",
            cost = 500
        ),
        Item(
            id = "item_neon_katana",
            name = "Neon Katana",
            description = "Cyberpunk glowing katana resting on the desk.",
            type = "Mascot",
            cost = 400
        ),
        Item(
            id = "theme_void_nexus",
            name = "Void Nexus",
            description = "Deep space anomaly with swirling dark matter.",
            type = "Theme",
            cost = 400
        ),
        Item(
            id = "theme_sakura_drift",
            name = "Sakura Drift",
            description = "Midnight cherry blossoms with falling petals.",
            type = "Theme",
            cost = 450
        )
    )
