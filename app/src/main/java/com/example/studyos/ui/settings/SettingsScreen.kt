...
fun SettingsScreen(back: () -> Unit) {
    ...
    if (showCode) {
        ...
        AlertDialog(
            ...
            title = { Text("Enter Admin Code", fontWeight = FontWeight.Bold, fontSize = 18.sp) },
            ...
            dismissButton = { TextButton(onClick = { showCode = false }) { Text("Cancel", fontWeight = FontWeight.Medium) } }
        )
    }
}